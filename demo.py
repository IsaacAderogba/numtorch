...
from numtorch.layers import LinearLayer, SequentialLayer, TanhNonLayer, SigmoidNonLayer, MSELossLayer
...
optimizer = SGDOptimizer(params=model.get_params(), alpha=1)
